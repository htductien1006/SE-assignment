                ...
                <div className={`tabs__content__1`}>
                    ...
                    <div className={`tabs__content__1__Co2`}>
                        <div className={`tabs__content__1__Co2__Row1`}>
                            <BsFillPeopleFill style={{width: '4rem', height: '4rem', color: 'black'}}/>
                            <span style={{fontSize: '3rem', color: 'black', marginLeft: '1rem'}}>: 10</span>
                        </div>
                        <div className={`tabs__content__1__Co2__Row2`}>
                            <BsTruck style={{width: '4rem', height: '4rem', color: 'black'}}/>
                            <span style={{fontSize: '3rem', color: 'black', marginLeft: '1rem'}}>: 30</span>
                        </div>
                    </div>
                </div>
            </div>
